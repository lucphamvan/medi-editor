    ...
    <>
      {isEmptyNode && (
        <Flex
          ...
          minH="40px"
          position="absolute"
          top={rect?.bottom ? rect.bottom - 35 + window.scrollY + "px" : "0px"}
          left={rect?.left ? rect.left - 60 + window.scrollX + "px" : "0px"}
          bg="white"
        >
          <Center minH="40px">
            <Icon
...
export default ActionMenuPlugin;
